...
fn nonexistent() {
    ...
    assert_eq!(
        assert_index_path(&indices, "https://github.com/rust-lang/crates.io-index"),
...
fn is_file() {
    ...
    assert_eq!(
        assert_index_path(&indices, "https://github.com/rust-lang/crates.io-index"),
        Err(format!(
            "{} (index directory for https://github.com/rust-lang/crates.io-index) not a directory",
...
fn two() {
    ...
    assert_eq!(
        assert_index_path(&indices, "file:///usr/local/share/cargo"),
